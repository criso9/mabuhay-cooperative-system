      	...
      	<div class="x_content">
			...
			<div class="row" style="margin-bottom: 30px;">
          		<div class="col-md-12 col-sm-12 col-xs-12 text-center">
          			{{ Form::open(array('route' => 'officer.member.index.filter', 'method' => 'post', 'class' => 'form-horizontal form-label-left pending-type', 'style' => 'width: 22%;float: right; right: -15px;top: 0px;')) }}
				...
				<div class="col-md-12 col-sm-12 col-xs-12 text-center">
					<ul class="pagination pagination-split member-filter">
						@foreach($filters as $f)
				          <li>
				          <a href="{{url('/officer/member')}}?f={{$f}}&s={{$status_filter}}" selected="{{ $f == $selected_filter ? "true" : "false" }}">{{$f}}</a>
				      		</li>
				        @endforeach
					</ul>
					<!-- {{ Form::close() }} -->
				            ...
				            <div class="well profile_view">
				              ...
				              <div class="col-xs-12 bottom text-center">
				                <div class="col-xs-12 emphasis">
				                  <a href="{{url('/officer/member/show/'.$member->id)}}" class="btn btn-primary btn-xs" style="width: 87px;">
				...
				@elseif ($members->count() > 0)
				    <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
				            <div class="well profile_view">
				              ...
				              <div class="col-xs-12 bottom text-center">
				                <div class="col-xs-12 emphasis">
				                  <a href="{{url('/officer/member/show/'.$members[0]->id)}}" class="btn btn-primary btn-xs" style="width: 87px;">
				                  	 <i class="fa fa-user"> </i> View Profile
				                  </a>
				                </div>
				              </div>
