    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <div style="clear:both;"></div>
      	<br/>
          {{ Form::open(array('route' => 'admin.business.index.filter', 'method' => 'post', 'class' => 'form-horizontal form-label-left pending-type business-list', 'style' => 'width: 240px;float: right; right: -15px;top: 58px;')) }}
