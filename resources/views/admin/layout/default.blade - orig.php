...
<head>
    ...
    <link href="{{ asset('js/Lightweight-Chart/cssCharts.css') }}" rel="stylesheet" type="text/css" />
</head>
<body>
	<div id="wrapper">
		<nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><strong><i class="icon fa fa-plane"></i> Mabuhay COOP</strong></a>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="{{url('/')}}"><i class="fa fa-gear fa-fw"></i> Home</a>
                        </li>
                        <li class="divider"></li>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
					 ...
					 <li>
                        <a href="#"><i class="fa fa-sitemap"></i> CRUD<span class="fa arrow"></span></a>
